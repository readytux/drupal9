...
function mili_form_system_theme_settings_alter(&$form, &$form_state) {
  ...
  $form['general'] = [
    '#type'  => 'details',
    '#title' => t('General'),
    '#description' => t('<h3>Thanks for using Mili Theme</h3>Mili is a free Drupal 8 and 9 theme designed and developed by <a href="https://drupar.com" target="_blank">Drupar.com</a>'),
    '#group' => 'mili',
  ];
  ...
  $form['sidebar']['front_sidebar'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Show Sidebar on Homepage'),
    '#description'   => t('This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/milipro" target="_blank">Buy MiliPro for $19 only.</a>'),
  ];
  ...
  $form['content']['font_icons']['font_icon_fontawesome'] = [
    ...
    '#description'   => t('Check this option to enable FontAwesome 4 font icons. Uncheck to disable.<br /><br />Mili theme has included FontAwesome v4.7.0 font icons. You can use any FontAwesome 4 font icon with Mili theme.<br />Please visit this tutorial page for details. <a href="https://www.drupar.com/custom-shortcodes-set-two/fontawesome-font-icons" target="_blank">How To Use FontAwesome Font Icons</a>.<br /><br /><hr /><br />'),
  ];
  $form['content']['font_icons']['font_icon_fontawesome5'] = [
    '#type'        => 'fieldset',
    '#title'       => t('Font Awesome 5'),
    '#description'   => t('<p>This feature is available in the premium version of this theme. <a href="https://www.drupar.com/theme/milipro" target="_blank">Buy MiliPro for $19 only.</a></p>'),
  ];
